...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		// PART TIME EMPLOYEE because emp3 is an instance of part time employee
		
		// emp3.getHourlyRate(); // returns syntax error because ...
		// The method getHourlyRate() is undefined for the type Employee
		...
		// This instruction returns a ClassCastException at run time because ...
		// 
		// class employee.Employee cannot be cast to class employee.PartTimeEmployee 
		// (employee.Employee and employee.PartTimeEmployee are in module cs361languages 
		// of loader 'app')
